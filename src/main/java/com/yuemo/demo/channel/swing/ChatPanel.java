 ...
 * 聊天面板
 *
 * <p>提供消息显示区域和输入框，支持用户输入消息和显示来自所有通道的消息。
 * 通过回调函数将用户输入传递给外部处理。</p>
 */
public class ChatPanel {
     ...
     * 构造方法
     *
     * @param onSendMessage 用户发送消息时的回调，参数为消息内容
     */
     ...
     * 追加消息到聊天区域
     *
     * <p>在 EDT 线程中安全地追加消息，根据来源类型使用不同颜色。</p>
     *
     * @param sender  发送者名称
     * @param content 消息内容
     * @param source  消息来源类型
